...
제한 시간 **2분** 동안 장난감 방을 돌아다니며 재료(블록, 판자, 바퀴, 스풀, 공…)를 주워 **노란 차고지**로 옮기세요. 시간이 끝나면 차고지 안의 재료만 내 것이 됩니다. Phase 2(조립), Phase 3(레이싱)는 순차 업데이트 예정입니다. 자세한 로드맵은 [docs/ROADMAP.md](docs/ROADMAP.md) 참고.
